			...
			'/engineer/': [
				{
					...
					collapsable: true,
					sidebarDepth: 2,
					children: [['/engineer/deploy/', 'docker部署']]
				},
				{
					title: 'vuepress',
					collapsable: true,
				...
				},
				{
					...
					collapsable: true,
					sidebarDepth: 2,
					children: [['/engineer/build/module/webpack/', 'webpack笔记']]
				},
				{
					title: 'rollup',
					collapsable: true,
					sidebarDepth: 2,
					children: [['/engineer/build/module/rollup/', 'rollup笔记']]
				},
				{
					title: 'vite',
					collapsable: true,
					sidebarDepth: 2,
					children: [['/engineer/build/module/vite/', 'vite笔记']]
				},
				{
					title: 'Git命令',
					collapsable: true,
					sidebarDepth: 2,
					children: [['/engineer/git/cmd/', '常用命令说明']]
				},
				{
					title: 'gitflow',
					collapsable: true,
					sidebarDepth: 2,
					children: [['/engineer/git/gitflow/', '说明']]
				}
			],
			'/project/': [
				{
